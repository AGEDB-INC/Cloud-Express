...
export const stylesheet = [
  {
    ...
    style: {
      ...
      'background-color': function getBackgroundColor(ele) { return ele ? ele.data('backgroundColor') : '#FFF'; },
      'border-width': '3px',
      'border-color': function getBorderColor(ele) { return ele ? ele.data('borderColor') : '#FFF'; },
      'border-opacity': 0.6,
      'text-valign': 'center',
      'text-halign': 'center',
      ...
      'font-size': '10px',
      'text-wrap': 'ellipsis',
      'text-max-width': function getMaxWidth(ele) { return ele ? ele.data('size') : 55; },
    },
  },
  {
  ...
  },
  {
    ...
    style: {
      ...
      'line-color': function getLineColor(ele) { return ele ? ele.data('backgroundColor') : '#FFF'; },
      'target-arrow-color': function getTargetArrowColor(ele) { return ele ? ele.data('backgroundColor') : '#FFF'; },
